          ...
          <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1">
                Review and manage pending claims
              </p>
            </div>
            ...
            <div className="hidden md:block bg-white rounded-lg shadow-sm overflow-x-auto">
              <table className="w-full min-w-[600px]">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-semibold text-gray-900">
                      Claim ID
                    </th>
                    <th className="px-2 sm:px-4 py-2 sm:py-3 text-left text-xs font-semibold text-gray-900">
                      Member
                  ...
                  {claims.length === 0 ? (
                    ...
                    claims.map((claim) => (
                      <tr key={claim.id} className="hover:bg-gray-50 transition">
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs font-medium text-gray-900 break-words">
                          {claim.id.slice(-8)}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs text-gray-600 break-words">
                          {getMemberName(claim.memberId)}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs text-gray-600 break-words">
                          {claim.claimType}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs text-gray-900 font-medium break-words">
                          ₱{claim.amount}
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs text-gray-600 break-words">
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Member: {getMemberName(claim.memberId)}
                          </p>
                        </div>
